...
function Home() {
  return (
    <section className={styles.home}>
      <p>
        Hi, I’m Lizzie (she/her) – a linguist-turned-coder currently working as
        a Pega Apprentice.
        <br />
        <br />
        I started teaching myself to code in April 2023 when I was working as a
        freelance translator. I quickly became obsessed and started spending
        less and less time translating in favour of writing more lines of code.
        <br />
        <br />
        ...
        Jetty Technologies as a Pega Apprentice, where I’m learning the low-code
        system of Pega.
        <br />
        <br />I built this portfolio to document my learning and keep all my
        projects in one place. If you want to go right back to the beginning and
        see how much I’ve progressed, head over to the{" "}
